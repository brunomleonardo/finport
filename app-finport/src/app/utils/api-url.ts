...
export class API_CONSTANTS {
    public static API_ENDPOINT = 'https://localhost:44321/api';
    public static API_FIND_TICKER = API_CONSTANTS.API_ENDPOINT + '/tickers/getbyabbv';
    ...
    public static API_GET_OPERATIONS = API_CONSTANTS.API_ENDPOINT + '/useroperations/getoperations';
